...
class LinkedList {
    ...
    append(value) {
        while (this.headNode.nextNode) {                // WHILE there is a next-Node...    
    ...
    atIndex(index) {
        let currentIndex = 0;
        while (currentIndex !== index) {                // WHILE current-index is not index...
    ...
    contains(value) {
        while (this.headNode) {                         // WHILE there is a head-Node...
